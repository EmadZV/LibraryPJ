"""
Django settings for boook1 project.
...
SECRET_KEY = 'django-insecure-%qsymxp8i#^5y0xcewt!qifbadp5@(3+3n+j)vety7m=n@y2h^'
...
MIDDLEWARE = [
    ...
    'myauth.middleware.LastSeen'
]

ROOT_URLCONF = 'boook1.urls'
...
WSGI_APPLICATION = 'boook1.wsgi.application'
